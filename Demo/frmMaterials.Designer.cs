namespace Demo
{
  partial class frmMaterials
  {
    ...
    private void InitializeComponent()
    {
      ...
      // bsMaterials
      // 
      this.bsMaterials.PositionChanged += new System.EventHandler(this.bsMaterials_PositionChanged);
      // 
      // frmMaterials
      // 
      ...
      this.MdiChildActivate += new System.EventHandler(this.frmMaterials_MdiChildActivate);
